...
HD_PWD='e:/mycode/verilog/decpwmip_repo/edit_dec_pwm_v1_0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dec_pwm_v1_0.vdi -applog -m64 -messageDb vivado.pb -mode batch -source dec_pwm_v1_0.tcl -notrace
