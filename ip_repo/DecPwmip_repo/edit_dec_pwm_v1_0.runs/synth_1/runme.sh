...
HD_PWD='e:/mycode/verilog/decpwmip_repo/edit_dec_pwm_v1_0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dec_pwm_v1_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source dec_pwm_v1_0.tcl
