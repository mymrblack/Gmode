...
#define START_OFF_1		(0x80)

//reg4
#define MTIMER_START 	(1<<26)
#define MASTER_RST		(1<<22)

//reg6
#define START_OFF_2		(0x100<<8)

//reg7
#define HS_DIV			(95)
#define REF_CLK_DIV		(6<<8)
#define RES_ADJ			(1<<11)
#define NEG_PHASE		(1<<12)
#define MTIMER			(40<<15)//1us
...
#define TDC_BASEADDR XPAR_MYGMODE_0_S00_AXI_BASEADDR
