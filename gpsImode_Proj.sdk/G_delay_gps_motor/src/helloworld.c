...
//#define Imode BIN 82.3045
//#define Gmode BIN 38.986354
void TEST_gps_and_fifo(Lidar_Data *data);
void TEST_gps_and_fifo_and_SD(Lidar_Data *data);
void TEST_Gmode(Lidar_Data *data);
void TEST_G_motor_delay_SD(Lidar_Data *data);
...
int main(){
    init_platform();
    TDC_config();
//    TDC_TimeDataAllocate_test();
//    FIFO_test(lidarData);
//    TEST_gps_and_fifo(lidarData);
    TEST_G_motor_delay_SD(lidarData);
...
void TEST_Gmode(Lidar_Data *data){
    ...
    delay_data.cycle = 20000;//200us
    delay_data.tstart_width = 3;
    delay_data.ch1_delay = 4000;
    delay_data.ch2_delay = 4;
    delay_data.ch3_delay = 5;
    delay_data.ch4_delay = 6;
    delay_data.ch1_width = 3;
    delay_data.ch2_width = 3;
    delay_data.ch3_width = 3;
    delay_data.ch4_width = 3;
    delay_init(&delay_data);

    print("Hello World\n\r");
    xil_printf("Gmode Example Test \r\n");
    xil_printf("Waiting for GPS initial.. \r\n");
	Gps_Init();
    xil_printf("GPS initialed.  \r\n");
    Gps_FuncTest();
...
void TEST_G_motor_delay_SD(Lidar_Data *data){
    ...
    delay_data.cycle = 20000;//200us
    delay_data.tstart_width = 3;
    delay_data.ch1_delay = 00;
    delay_data.ch2_delay = 10000;
    delay_data.ch3_delay = 10000;
    delay_data.ch4_delay = 10000;
    delay_data.ch1_width = 3;
    delay_data.ch2_width = 3;
    delay_data.ch3_width = 3;
    delay_data.ch4_width = 3;
    ...
    xil_printf("Waiting for motor initial.. \r\n");
    xil_printf("Please insure FIR(Pr 2.23) has been set. \r\n");
    sleep(1);
    //motor_init(&motor);
    xil_printf("Motor initialed.  \r\n");
   // motor_run_en();
